                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildNutrisiItem('nutritionItemBranchedChainAminoAcids'.tr()),
                      _buildNutrisiItem(
                          'nutritionItemOmega3'.tr()),
                      _buildNutrisiItem(
                          'nutritionItemVitaminD'.tr()),
                      _buildNutrisiItem(
                          'nutritionItemCalcium'.tr()),
                      _buildNutrisiItem(
                          'nutritionItemFruitsVegetables'.tr()),
                    ],
                  ),
                ),
              ),
